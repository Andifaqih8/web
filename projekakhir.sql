...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2024 pada 05.51
...
(16, 3, 1, 1, 'pilihan', 'Bagaimana Anda menilai kelengkapan dan kualitas fasilitas ruang kelas yang digunakan oleh anak Anda di institusi kami?'),
(17, 3, 1, 2, 'pilihan', 'Seberapa baik fasilitas pendukung seperti perpustakaan, laboratorium, dan pusat sumber belajar yang disediakan untuk menunjang pendidikan anak Anda?'),
(18, 3, 1, 3, 'pilihan', 'Bagaimana Anda menilai kebersihan, keamanan, dan kenyamanan lingkungan kampus tempat anak Anda belajar?'),
...
(38, 5, 3, 1, 'pilihan', 'Bagaimana Anda menilai kompetensi teknis dan keterampilan praktis mahasiswa yang bekerja sama dengan perusahaan Anda?'),
(39, 5, 3, 2, 'pilihan', 'Seberapa baik kemampuan komunikasi dan kerja sama tim mahasiswa dalam proyek atau kegiatan bersama?'),
(40, 5, 3, 3, 'pilihan', 'Bagaimana Anda menilai kesiapan mahasiswa dalam menghadapi tantangan dan menyelesaikan tugas yang diberikan oleh perusahaan Anda?');
...
--
ALTER TABLE `r_ortu`
  MODIFY `id_register_ortu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_jawaban_industri`
  MODIFY `id_jawaban_industri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `t_jawaban_ortu`
  MODIFY `id_jawaban_ortu` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `t_jawaban_tendik`
--
ALTER TABLE `t_jawaban_tendik`
  MODIFY `id_jawaban_tendik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `t_responden_industri`
  MODIFY `id_responden_industri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `t_responden_ortu`
  MODIFY `id_responden_ortu` int(11) NOT NULL AUTO_INCREMENT;
